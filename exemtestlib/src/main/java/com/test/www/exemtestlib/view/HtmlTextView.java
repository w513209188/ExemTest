package com.test.www.exemtestlib.view;
...
import com.test.www.exemtestlib.call.HtmlTextViewCall;
...
public class HtmlTextView extends RelativeLayout {
    ...
    private void initView(Context context,AttributeSet attributeSet){
        ...
        Log.e("isOption",R.styleable.HtmlTextView_errorOption+"");
    ...
    public void onClickOption(OnClickListener onClickListener){
        ...
        txt_tv.setOnClickListener(onClickListener);
    }
}
